...
We already installed Mongo, if you need to reinstall, [follow the directions here](https://git.generalassemb.ly/misteroh/SEIR-FLEX-ADA/blob/master/unit_1/w08d3/instructor_notes/INSTALL_MONGO.md)
