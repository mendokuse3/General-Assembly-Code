...
#### Using ejs or jsx
The notes below will be written usen `jsx` as the templating language to render our views. If you would like to stick with `ejs` you are welcome to! 
...
1. create `index.ejx` and change your `res.send` to `res.render` this page
1. upgrade  your route and ejx to render all the logs in your database, just make an unordered list of the titles for now
...
1. upgrade your `index.ejx` so that each title links to its show page
1. Create a `show.ejx` and add HTML
 - show the title
 - show the entry
...
1. upgrade your `res.send` to a `res.render` of your `show.ejx`
1. don't forget to `git add` and `git commit` your work, give yourself an informative commit message so you can trace back your work, if you need to

### Delete Route
1. Fill out your Restful table
1. in your `index.ejx`, add a delete form
...
### Edit Route
1. Fill out your Restful table
1. in your `index.ejx`, add a link to your edit route
1. create your edit route in your `server.js`
1. create your `edit.ejx`
1. test it to make sure it works as expected (be sure to populate your form with your log's data)
1. don't forget to `git add` and `git commit` your work, give yourself an informative commit message so you can trace back your work, if you need to

### Put Route
1. Fill out your Restful table
1. upgrade your` edit.ejx` form to have the appropriate action and method
