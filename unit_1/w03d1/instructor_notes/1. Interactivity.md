...
1. Add an `index.html` file, a `js` folder and a `script.js` file to this folder.
1. Connect the `script.js` to your `index.html` file and open in the `index.html` file in the browser! 
