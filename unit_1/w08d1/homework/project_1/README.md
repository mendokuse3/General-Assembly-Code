...
We will **still have some instruction and other mandatory items** during project week, as follows:
  ...
  - **Tuesday**: You're required to show up in the class zoom we can make sure you've all deployed onto GitHub pages correctly
...
- Make sure to submit the final project url via this [Google Form](https://forms.gle/mC9pJeGyxL2HMeqe9)
...
**Satuday, October 19th (Today!) - Mandatory**<br>
...
Your project is due on Saturday, October 16th at 10:00 am EST. You will present your project and show your code to classmates and instructors.

:heavy_check_mark: Add your project to [this google sheet](https://docs.google.com/spreadsheets/d/1ElR7DxYL-qfZgkZ3F9r2etBIwDRhxvGJdp57QMH-T1E/edit?usp=sharing). Note that this will be the order you present your projects!
