...
// // 8
// for (let ringCheck of solarSystem){
//     ringCheck.ringSystem === true ? console.log(ringCheck) : false;
// };
// SOLAR SYSTMEM PART 2 //
...
// 4
typeof(system.Mercury.radiusp === String) ? system.Mercury.radiusp = system.Mercury.radiuse : false;
