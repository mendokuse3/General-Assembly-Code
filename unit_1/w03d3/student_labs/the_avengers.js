...
// // 2
// for (let moves of ironMan.abilities){
//     console.log(moves);
// }
// // 3
...
//         },
//         abilities: ["Cool Shield", "Sweet Uniform", "Peak Human Strength"],
//         sayPhrase: () => {
...
// const blackWidow = {
//     aliases: {
//         realName: "Natalia Alinovna Romanova",
//         otherNotableAliases: ["Mrs. Awesome", "Fancy Pants", "Natalie Rushman"]
//     }
// };
...
//   for (let superNames in theAvengers) {
//       console.log(theAvengers[superNames].name);
//   }
...
//   for (let names of instruments.guitar.electric) {
//       console.log(names);
//   }
//   instruments.vocals = ["Whiney Houston", "Freddie Mercury", "The Weeknd"];
