...
... WAIT let's try something new!

Instead of using `.bind` you can use an arrow function!

[I forget what bind is](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_objects/Function/bind)
[Why does an arrow function work here?](https://hackernoon.com/javascript-es6-arrow-functions-and-lexical-this-f2a3e2a5e8c4)
