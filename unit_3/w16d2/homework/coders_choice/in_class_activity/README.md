...
## Intro
GitHub allows for amazing collaboration to happen! For tonight’s homework, you will be asked to complete the task in groups of 2 or more. For this warm up exercise, we will work together to get you setup to help collaboration this evening go smoothly.
...
- [Tonight's Homework](../homework)
- [How to tell if you're working in groups](../../w16d1/homework/project_3/working_in_groups.md)
...
### Resources
- [Class Wiki](https://git.generalassemb.ly/misteroh/SEIR-FLEX-ADA/wiki/Git-Cheatsheet)
- [Happy Fun Ball](/unit_3/w15d2/student_labs)
