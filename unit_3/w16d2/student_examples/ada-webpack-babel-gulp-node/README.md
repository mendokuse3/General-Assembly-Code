...
- Most people use a CLI Tool like Vue-Cli or Create React App and they have no idea what these things are doing.
- The goal of this starter kit is for it to be a tool that let's you learn JS at a new level because you will have access to everything under the hood and no opinionated set up.
