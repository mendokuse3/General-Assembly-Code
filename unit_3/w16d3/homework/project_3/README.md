...
If you forget how to do this try re-reading the environment variables section on this page:
[Go to Environment Variables Section](https://git.generalassemb.ly/misteroh/SEIR-FLEX-ADA/blob/master/unit_2/w09d2/instructor_notes/URL_PARAMS.md)

__NOTE__: If you are not using Webpack, you will need to make an endpoint that could expose the environment variables for now. Going forward, you would want to be using Webpack which will allow you to effectively hide the variables and not allow them to be exposed via an endpoint.
...
* **[Mongo Cheatsheet](https://git.generalassemb.ly/misteroh/SEIR-FLEX-ADA/wiki/Mongo-Cheatsheet)**
</details>
<hr>  
